...
import { BarChart3, Stethoscope, ClipboardList, FileWarning, HeartPulse, X, Menu, ChevronLeft, ChevronRight } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { label: "Boletim Seg. Paciente", href: "/seguranca", icon: HeartPulse },
];
